...
Returns the invoice PDF as the response body (binary). The client should save it using `Content-Disposition` or a default filename — do not expect a presigned S3 URL.
