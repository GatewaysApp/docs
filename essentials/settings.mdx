...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages in the [Mintlify API documentation](https://mintlify.com/docs/api-playground/openapi/setup).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more in the [Mintlify API playground documentation](https://mintlify.com/docs/api-playground/overview)
        </ResponseField>
      </Expandable>
    </ResponseField>
